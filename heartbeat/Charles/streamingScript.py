...
# Load in data
# In the online system, i'm not sure exactly what this will look like q
# uite yet, but it should be *SOMETHING* where we can just get a tensor
# in the format our model is expecting
